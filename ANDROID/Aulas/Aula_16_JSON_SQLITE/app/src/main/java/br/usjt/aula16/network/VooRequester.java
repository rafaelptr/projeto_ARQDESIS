package br.usjt.aula16.network;
...
import br.usjt.aula16.model.Voo;
...
public class VooRequester {
    ...
    public ArrayList<Voo> get(String url, String pOrigem, String pDestino,String pData) throws IOException {
        ...
        try {
            ...
            for (int i = 0; i < root.length(); i++ ) {
                ...
                lista.add(new Voo(nome,origem,destino,data,imagem,preco));
            }
            ...
            if(lista.size() == 0)
                //Voo.NAO_ENCONTRADA
                lista.add(new Voo(Voo.NAO_ENCONTRADO,pOrigem, pDestino, pData, "voo_nenhum", 0.0));
        }
        return lista;
    }
