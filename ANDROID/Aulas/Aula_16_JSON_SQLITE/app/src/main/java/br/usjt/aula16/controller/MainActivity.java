package br.usjt.aula16.controller;
...
import br.usjt.aula16.R;
import br.usjt.aula16.data.AeroportosDb;
import br.usjt.aula16.model.Voo;
import br.usjt.aula16.network.VooRequester;
    ...
    public void consultar(View view, String modo){
        ...
        if(requester.isConnected(this)) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        voos = requester.get("http://" + servidor + "/ProjetoARQDESIS_Java/ListagemVooJson", passarOrigem, passarDestino, passarData);
