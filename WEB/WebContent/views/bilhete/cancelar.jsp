<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page import="to.*"%>
<form class="form-horizontal" action='CancelarBilhete' method='POST'>
	<fieldset>
	<legend><%= Idioma.para(request, "efetuar_cancelamento")%></legend>
	...
	<div class="form-group">
	  <div class="col-md-3 col-md-offset-4">
		<button class='btn btn-success' type="submit" ><i class="glyphicon glyphicon-floppy-disk"></i>&ensp;<%= Idioma.para(request,"efetuar_cancelamento") %></button>
	  </div>
	</div>
