 ...
 */
@WebServlet("/BuscarVooJson")
public class BuscarVooJson extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BuscarVooJson() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	Voo voo = new Voo();
    	String origem = (request.getParameter("origem") != null ? request.getParameter("origem") : "0");
    	String destino = (request.getParameter("destino") != null ? request.getParameter("destino") : "0");
    	
    	ListagemVooTO listagem = voo.listagem(origem,destino);
